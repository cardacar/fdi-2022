		...
		<div className={` bg-background`} id='problema'>
			<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex'>
				<div className={`w-full p-6 text-center`}>
					...
					<div className={`align-middle flex-shrink`}>
						<p className={`text-gray-600 mb-8 text-justify flex-grow`}>
							Se realiza una explicación de los conceptos de inteligencia
							...
							como defensivas y los métodos utilizados por la inteligencia
							artificial. Para poder realizar el análisis de la aplicación de la
							inteligencia artificial a ciberseguridad se muestran las
